...
For browser work, prefer Tars's dedicated persistent profile and local helper scripts over attaching to the human's active browser session. The default LinkedIn entrypoints are:
